...
class ArcherTowerLong(Tower):
    ...
    def draw(self, win):
        ...
        archer = self.archer_imgs[self.archer_count // 14]
        win.blit(archer, (self.x - (archer.get_width() / 2), (self.y - archer.get_height() - 15)))  # archer
    ...
    def attack(self, enemies):
        ...
        if len(enemy_closest) > 0:
            ...
            if self.archer_count == 40:
                if first_enemy.hit(self.damage) is True:
